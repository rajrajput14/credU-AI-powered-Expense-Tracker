...
const Transactions = () => {
    const { transactions, setTransactionModal, user } = useAppStore();
        ...
        <div className="flex-1 flex flex-col w-full font-body">
            ...
            <div className="flex-1 overflow-x-hidden overflow-y-auto p-6 md:p-8 space-y-8 max-w-7xl mx-auto w-full">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight text-on-surface mb-1 font-headline">Transactions History</h1>
                        <p className="text-on-surface-variant text-sm font-medium">Manage and review your recent financial activity.</p>
                    </div>
